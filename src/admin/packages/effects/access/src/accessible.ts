    ...
    if (
      ...
      const merged = {
        ...
        meta: {
          ...
          domCached: route.meta?.domCached ?? existing.meta?.domCached,
          fullPathKey: route.meta?.fullPathKey ?? existing.meta?.fullPathKey,
          keepAlive: route.meta?.keepAlive ?? existing.meta?.keepAlive,
        },
      } as RouteRecordRaw;
